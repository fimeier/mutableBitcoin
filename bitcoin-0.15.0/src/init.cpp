...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    /*
     * merkel patricia tree //mefi84
     */

    CVerifyDB().OpenMerkelPatriciaTree();
    CVerifyDB().InitMerkelPatriciaTree(chainparams);


    /*if(!CVerifyDB().VerifyDB(Params(), pcoinsTip, 5, 5)){
    	LogPrintf("error Merkel Patricia Tree.....");
    } else {
    	LogPrintf("Merkel Patricia Tree initialized: root=%s", CVerifyDB().getRootMerkelPatriciaTree());
    }*/
