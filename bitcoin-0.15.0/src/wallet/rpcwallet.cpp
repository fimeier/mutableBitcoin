...
void WalletTxToJSON(const CWalletTx& wtx, UniValue& entry)
{
    ...
    entry.push_back(Pair("rValue", wtx.tx->rValue.GetHex())); //mefi84
    entry.push_back(Pair("sValue", wtx.tx->sValue.GetHex())); //mefi84
    entry.push_back(Pair("rscriptSig", wtx.tx->rscriptSig.GetHex())); //mefi84 scriptSig
    entry.push_back(Pair("sscriptSig", wtx.tx->sscriptSig.GetHex())); //mefi84 scriptSig
