                                ...
                                int& nChangePosInOut, std::string& strFailReason, const CCoinControl& coin_control, bool sign)
{
    ...
    CBlockIndex* bestBlock = chainActive.Tip(); //mefi84 //todo change r/s value WIE BEI rawtransaction
    //uint256 bBH = bestBlock->GetBlockHash();
    uint1024 bBH = uint1024F256(bestBlock->GetBlockHash()); //mefi84
    txNew.rValue = bBH; ///mefi84 uint1024 //TODO change r/s values
    txNew.sValue = bBH; //mefi84 uint1024 //TODO change r/s values
    txNew.rscriptSig = bBH; //mefi84 scriptSig
    txNew.sscriptSig = bBH; //mefi84 scriptSig
